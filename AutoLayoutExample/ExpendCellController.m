...
@interface ExpendCellController () <UITableViewDelegate, UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    [self.datas enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        [self.adapters addObject:[ExpendLayoutCell dataAdapterWithData:[ExpendLayoutCellModel modelWithString:obj]]];
    }];
    ...
    // 注册cell
    [ExpendLayoutCell registerToTableView:self.tableView];
}
